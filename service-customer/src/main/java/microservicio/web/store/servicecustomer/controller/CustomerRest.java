...
import microservicio.web.store.servicecustomer.service.CustomerService;
...
public class CustomerRest {
    ...
    @PostMapping
    public ResponseEntity<Customer> createCustomer(@RequestBody Customer customer, BindingResult result) {//(@Valid @RequestBody Customer customer, BindingResult result) {
