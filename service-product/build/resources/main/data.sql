CREATE TABLE tbl_categories ( id INT PRIMARY KEY, name VARCHAR(20) );
CREATE TABLE tbl_products ( id INT PRIMARY KEY, name VARCHAR(90),
 description VARCHAR(200), stock INT,price DOUBLE,status VARCHAR(10), create_at VARCHAR(20),category_id INT);
