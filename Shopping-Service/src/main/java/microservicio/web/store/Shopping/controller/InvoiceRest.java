package microservicio.web.store.Shopping.controller;
...
import microservicio.web.store.Shopping.service.InvoiceService;
...
// nuevo codigo para crear un log de la aplicacion
@Slf4j
@RestController
...
public class InvoiceRest {
    ...
    // -------------------Create a Invoice-------------------------------------------
    @PostMapping
    public ResponseEntity<Invoice> createInvoice(@RequestBody Invoice invoice, BindingResult result) {//@Valid @RequestBody Invoice invoice, BindingResult result) {
